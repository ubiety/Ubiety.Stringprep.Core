...
namespace Ubiety.Stringprep.Core.Generated
{
    ...
    internal static class Tables
    {
        ...
        public static readonly Dictionary<int, int[]> B1 = new ()
        {
            ...
            { 0x1806, Array.Empty<int>() }, // Map to nothing
            { 0x180B, Array.Empty<int>() }, // Map to nothing
            { 0x180C, Array.Empty<int>() }, // Map to nothing
            { 0x180D, Array.Empty<int>() }, // Map to nothing
            { 0x200B, Array.Empty<int>() }, // Map to nothing
            { 0x200C, Array.Empty<int>() }, // Map to nothing
            { 0x200D, Array.Empty<int>() }, // Map to nothing
            { 0x2060, Array.Empty<int>() }, // Map to nothing
            { 0xFE00, Array.Empty<int>() }, // Map to nothing
            { 0xFE01, Array.Empty<int>() }, // Map to nothing
            { 0xFE02, Array.Empty<int>() }, // Map to nothing
            { 0xFE03, Array.Empty<int>() }, // Map to nothing
            { 0xFE04, Array.Empty<int>() }, // Map to nothing
            { 0xFE05, Array.Empty<int>() }, // Map to nothing
            { 0xFE06, Array.Empty<int>() }, // Map to nothing
            { 0xFE07, Array.Empty<int>() }, // Map to nothing
            { 0xFE08, Array.Empty<int>() }, // Map to nothing
            { 0xFE09, Array.Empty<int>() }, // Map to nothing
            { 0xFE0A, Array.Empty<int>() }, // Map to nothing
            { 0xFE0B, Array.Empty<int>() }, // Map to nothing
            { 0xFE0C, Array.Empty<int>() }, // Map to nothing
            { 0xFE0D, Array.Empty<int>() }, // Map to nothing
            { 0xFE0E, Array.Empty<int>() }, // Map to nothing
            { 0xFE0F, Array.Empty<int>() }, // Map to nothing
            { 0xFEFF, Array.Empty<int>() }, // Map to nothing
        };
