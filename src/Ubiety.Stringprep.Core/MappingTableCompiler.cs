...
namespace Ubiety.Stringprep.Core
{
    ...
    {
        public static IDictionary<int, int[]> Compile(IDictionary<int, int[]>[] baseTables,
            IDictionary<int, int[]>[] inclusions, int[] removals)
        {
        ...
        private static IDictionary<int, int[]> DoInclude(IDictionary<int, int[]> dict,
